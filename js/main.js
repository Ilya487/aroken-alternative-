...
(function () {
  ...
  document.addEventListener("click", (e) => {
    if (e.target.closest(".burger") || e.target.closest(".overlay")) {
  ...
  setInterval(() => {
    if (pageYOffset > 0 && !menu.classList.contains("header__menu--open"))
      burger.classList.add("burger--go");
    else burger.classList.remove("burger--go");
  }, 0);
})();
